...
from .views import DeliveryDetailView, DeliveryListCreateView, MaterialDetailView, MaterialListCreateView, MaterialMovementListCreateView, OrderDetailView, OrderListCreateView, all_materials_stock_by_workshop, material_stock_view
